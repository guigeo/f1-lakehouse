...
class Sender:
    ...
    def process_file(self, filename):
        ...
        # pega o ano (primeiro elemento do nome)
        year = file.split("_")[0]

        bucket_path = os.path.join(self.bucket_folder, f"year={year}", file)
...
#send = Sender("gbrj-f1-lakehouse", "raw/results")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--bucket_path",default="raw/results", type=str)
